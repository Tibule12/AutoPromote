...
async function testPromotionTriggers() {
  try {
    ...
    const schedulesSnapshot = await db.collection('promotion_schedules').where('contentId', '==', contentId1).get();
    ...
    const schedulesSnapshot2 = await db.collection('promotion_schedules').where('contentId', '==', contentId2).get();
    ...
    const schedulesSnapshot3 = await db.collection('promotion_schedules').where('contentId', '==', contentId3).get();
