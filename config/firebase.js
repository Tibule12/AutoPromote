...
try {
  ...
  if (process.env.FIREBASE_SERVICE_ACCOUNT) {
    ...
    adminConfig = {
      ...
      databaseURL:
        process.env.FIREBASE_DATABASE_URL || `https://${serviceAccount.project_id}.firebaseio.com`,
      storageBucket:
  ...
  // Try to load from file as the third option
    ...
    try {
      ...
      console.log(
        `ℹ️ Using application default credentials with project ID: ${adminConfig.projectId || "unknown"}`
      );
    }
  }
} catch (error) {
