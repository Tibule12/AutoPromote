...
const VISIBILITY_ZONES = {
  tiktok: {
    fyp: {
      name: "For You Page",
      reach: "massive",
      requirements: ["trending_sound", "hook", "engagement_rate > 0.15"],
    },
    trending: {
      name: "Trending Tab",
      reach: "high",
      requirements: ["hashtag_trending", "rapid_engagement"],
    },
    discover: {
      name: "Discover Page",
      reach: "medium",
      requirements: ["niche_hashtags", "quality_score > 0.7"],
    },
  },
  instagram: {
    explore: {
      name: "Explore Page",
      reach: "massive",
      requirements: ["high_engagement", "quality_content", "saves > 100"],
    },
    reels: {
      name: "Reels Tab",
      reach: "high",
      requirements: ["video_format", "trending_audio", "watch_time > 0.8"],
    },
    hashtag: {
      name: "Hashtag Pages",
      reach: "medium",
      requirements: ["relevant_hashtags", "engagement_rate > 0.1"],
    },
  },
  youtube: {
    recommended: {
      name: "Recommended",
      reach: "massive",
      requirements: ["ctr > 0.08", "watch_time > 0.5", "engagement"],
    },
    trending: {
      name: "Trending",
      reach: "high",
      requirements: ["rapid_views", "shares", "comments"],
    },
    shorts: {
      name: "Shorts Feed",
      reach: "high",
      requirements: ["vertical_video", "hook", "under_60s"],
    },
  },
  twitter: {
    trending: {
      ...
      reach: "massive",
      requirements: ["hashtag_trending", "retweets", "engagement"],
    },
    timeline: {
      name: "For You Timeline",
      reach: "high",
      requirements: ["engagement_rate > 0.05", "relevance"],
    },
  ...
  facebook: {
    news_feed: {
      name: "News Feed",
      reach: "high",
      requirements: ["engagement", "shares", "comments"],
    },
...
async function trackExposureSaturation(contentId, platforms) {
  try {
    ...
    for (const platform of platforms) {
      // Get seeding data
      const seedingSnapshot = await db
        .collection("viral_seeding")
