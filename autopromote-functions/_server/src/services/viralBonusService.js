...
class ViralBonusService {
  constructor() {
    ...
    this.MILESTONES = [
      { id: "viral_tier_1", threshold: 30000, reward: 3.00 },
      { id: "viral_tier_2", threshold: 100000, reward: 5.00 }, // +$5 = $8 total
      { id: "viral_tier_3", threshold: 500000, reward: 12.00 } // +$12 = $20 total
    ];
  }
