...
class CaptionGenerationService {
  ...
  getPlatformSpecs(platform) {
    const specs = {
      instagram: {
        ...
        requirements:
          "Instagram users love authentic, visual storytelling. Use line breaks for readability.",
      },
      tiktok: {
        maxLength: 300,
        ...
        requirements:
          "TikTok captions should be short, punchy, and trend-aware. Reference sounds or challenges if relevant.",
      },
      youtube: {
        maxLength: 5000,
        ...
        requirements:
          "YouTube descriptions can be longer. Include timestamps, links, and detailed info.",
      },
      twitter: {
        maxLength: 280,
      ...
      linkedin: {
        ...
        requirements:
          "LinkedIn requires professional, value-driven content. Share insights and lessons learned.",
      },
      pinterest: {
        maxLength: 500,
  ...
  estimateEngagement(parsed, platform) {
    ...
    const hasCTA = ctaKeywords.some(keyword => parsed.caption.toLowerCase().includes(keyword));
    if (hasCTA) {
      score += 15;
    }
