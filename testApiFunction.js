...
async function testApiFunction() {
  try {
    ...
    const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithCustomToken?key=AIzaSyBA9It1gCyKBpqAhGM5TxwdNoe68c3qEBE', {
      method: 'POST',
    ...
    const apiResponse = await fetch('https://us-central1-autopromote-cc6d3.cloudfunctions.net/api', {
      method: 'GET',
