...
async function ensurePuppeteer() {
  try {
    ...
    console.error(
      "Puppeteer not installed. Please run `npm install puppeteer` in the repo root and re-run this script."
    );
    process.exit(2);
  }
}
...
(async () => {
  ...
  jobs.push({
    src: "evidence/semgrep_report_20251101112958.json",
    name: "semgrep_report_20251101112958",
  });
