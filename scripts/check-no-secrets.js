...
const ignore = ['node_modules', '.git', 'frontend/build', 'dist', 'public', 'node_modules', '.env.example', 'test/e2e', 'test/e2e/tmp', '\\bexample\\b', 'TROUBLESHOOTING_401.md', 'REGENERATE_CREDENTIALS.md', 'FIREBASE_SETUP.md', 'README.md', 'SECURITY.md', 'docs'];
const patterns = [
  /-----BEGIN PRIVATE KEY-----/i,
