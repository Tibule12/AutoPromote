...
const target = process.argv[2] || path.resolve(__dirname, '..', 'test', 'e2e', 'tmp', 'service-account.json');
...
if (!raw && !rawB64) {
  console.warn('No FIREBASE_ADMIN_SERVICE_ACCOUNT or FIREBASE_ADMIN_SERVICE_ACCOUNT_BASE64 exists in env; nothing to write.');
  process.exit(0);
}
