...
try {
  ...
  async function runChecks() {
    ...
    if (!authWorking) {
      ...
      console.log('   - Go to: https://console.firebase.google.com/project/' + serviceAccount.project_id + '/authentication/users');
    ...
    if (!firestoreWorking) {
      ...
      console.log('   - Go to: https://console.firebase.google.com/project/' + serviceAccount.project_id + '/firestore');
