...
describe("isAllowedAuthUrl helper", () => {
  ...
  it("allows known oauth hostnames", () => {
    ...
    expect(
      isAllowedAuthUrl(
        "https://accounts.snapchat.com/accounts/oauth2/auth?client_id=abc&redirect_uri=https%3A%2F%2Fapi.example.com%2Fcallback"
      )
    ).toBe(true);
  });
  ...
  it("rejects other origins", () => {
    expect(isAllowedAuthUrl("https://evil.com/redirect?target=https://www.youtube.com")).toBe(
      false
    );
