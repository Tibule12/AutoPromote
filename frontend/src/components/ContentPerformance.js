...
const ContentPerformance = ({ contentData, totalContent }) => {
  ...
  const prepareViewsByTypeData = () => {
    ...
    return contentData.viewsByType || {
      'Articles': 45,
      'Videos': 30,
      'Images': 15,
      'Audio': 10
          ...
          <div className="content-metric-card">
            ...
            <div className="metric-comparison">
              {contentData?.engagementTrend > 0 ? 
                <span className="trend-up">↑ {Math.abs(contentData?.engagementTrend || 0.5)}% vs last period</span> : 
                <span className="trend-down">↓ {Math.abs(contentData?.engagementTrend || 0.5)}% vs last period</span>
              }
            </div>
          </div>
          ...
          <div className="content-metric-card">
            ...
            <div className="metric-comparison">
              {contentData?.timeOnContentTrend > 0 ? 
                <span className="trend-up">↑ {Math.abs(contentData?.timeOnContentTrend || 0.3)}% vs last period</span> : 
                <span className="trend-down">↓ {Math.abs(contentData?.timeOnContentTrend || 0.3)}% vs last period</span>
              }
            </div>
          </div>
          ...
          <div className="content-metric-card">
            ...
            <div className="metric-comparison">
              {contentData?.completionRateTrend > 0 ? 
                <span className="trend-up">↑ {Math.abs(contentData?.completionRateTrend || 0.8)}% vs last period</span> : 
                <span className="trend-down">↓ {Math.abs(contentData?.completionRateTrend || 0.8)}% vs last period</span>
              }
            </div>
          </div>
          ...
          <div className="content-metric-card">
            ...
            <div className="metric-comparison">
              {contentData?.bounceRateTrend < 0 ? 
                <span className="trend-up">↑ {Math.abs(contentData?.bounceRateTrend || 0.6)}% vs last period</span> : 
                <span className="trend-down">↓ {Math.abs(contentData?.bounceRateTrend || 0.6)}% vs last period</span>
              }
            </div>
          </div>
        </div>
        ...
        <div className="progress-container">
          <div className="progress-header">
            ...
            <span className="progress-value">
              ...
              <span className="progress-secondary"> ({Math.round((contentData?.highPerforming || totalContent * 0.2) / totalContent * 100)}%)</span>
            </span>
          </div>
        ...
        <div className="progress-container">
          <div className="progress-header">
            ...
            <span className="progress-value">
              ...
              <span className="progress-secondary"> ({Math.round((contentData?.mediumPerforming || totalContent * 0.6) / totalContent * 100)}%)</span>
            </span>
          </div>
          <div className="progress-bar-bg">
            <div 
        ...
        <div className="progress-container">
          <div className="progress-header">
            ...
            <span className="progress-value">
              ...
              <span className="progress-secondary"> ({Math.round((contentData?.lowPerforming || totalContent * 0.2) / totalContent * 100)}%)</span>
            </span>
          </div>
          <div className="progress-bar-bg">
            <div 
      ...
      <div className="dashboard-panel">
        ...
        <div className="recommendation-list">
          <div className="recommendation-item">
            <div className="recommendation-icon" style={{ backgroundColor: "#e3f2fd", color: "#1976d2" }}>📈</div>
            <div className="recommendation-content">
              <h4 className="recommendation-title">Increase Video Content</h4>
              <p className="recommendation-description">
                Videos have 32% higher engagement than other content types. Consider converting some of your text-based
                content into short video formats.
              </p>
            </div>
          </div>
          
          <div className="recommendation-item">
            <div className="recommendation-icon" style={{ backgroundColor: "#f3e5f5", color: "#9c27b0" }}>⏱️</div>
            <div className="recommendation-content">
              <h4 className="recommendation-title">Optimize Content Length</h4>
              <p className="recommendation-description">
                Content between 800-1200 words performs best for engagement. Your current average is 1450 words, 
                which may be leading to higher bounce rates.
              </p>
            </div>
          </div>
          
          <div className="recommendation-item">
            <div className="recommendation-icon" style={{ backgroundColor: "#e8f5e9", color: "#2e7d32" }}>🎯</div>
            <div className="recommendation-content">
              <h4 className="recommendation-title">Target Trending Topics</h4>
              <p className="recommendation-description">
                Content related to "automation" and "AI tools" is trending with your audience. Consider creating more
