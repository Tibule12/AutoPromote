...
function ContentApprovalPanel() {
  ...
  if (loading) {
    return <div style={{ padding: 40, textAlign: 'center' }}>Loading content approval queue...</div>;
  }
            ...
            <div style={{ display: 'flex', gap: 15 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 15, flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleRequestChanges(item.id)} style={smallWarningButtonStyle}>
                    📝 Request Changes
                  </button>
