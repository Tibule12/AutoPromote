  ...
  return (
    ...
    >
      <h2 style={{ color: "#1976d2", marginTop: 0 }}>
        Database & Admin Dashboard Integration Tester
      </h2>
            ...
            {Object.entries(testResults).map(([test, { result, error, timestamp }]) => (
              <div
                ...
                style={{
                  ...
                  margin: "8px 0",
                  backgroundColor:
                    typeof result === "boolean" ? (result ? "#e8f5e9" : "#ffebee") : "#e3f2fd",
                  borderRadius: "4px",
                  borderLeft: `4px solid ${
                    typeof result === "boolean" ? (result ? "#4caf50" : "#f44336") : "#2196f3"
                  }`,
                }}
              >
                ...
                {error && <div style={{ color: "#d32f2f", marginTop: "4px" }}>Error: {error}</div>}
