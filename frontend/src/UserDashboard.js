          ...
          {!isMobile && (
            <>
              ...
              <aside className="dashboard-sidebar">
                ...
                <button className="logout-btn" onClick={onLogout} style={{margin:'1rem 0',padding:'0.7rem 1.5rem',background:'#6c4cf7',color:'#fff',border:'none',borderRadius:'8px',fontWeight:'700',cursor:'pointer'}}>Logout</button>
              </aside>
              {/* Main content */}
              ...
              <aside className="dashboard-rightbar">
                <nav className="dashboard-navbar-vertical">
                  <ul style={{listStyle:'none',padding:0}}>
                    <li className={activeTab === 'stats' ? 'active' : ''} onClick={() => setActiveTab('stats')} style={{cursor:'pointer',padding:'1rem',fontWeight:'bold',color:activeTab==='stats'?'#6c4cf7':'#222',background:activeTab==='stats'?'#ece8fa':'none',borderRadius:'8px',marginBottom:'0.5rem'}}>Stats</li>
                    <li className={activeTab === 'upload' ? 'active' : ''} onClick={() => setActiveTab('upload')} style={{cursor:'pointer',padding:'1rem',fontWeight:'bold',color:activeTab==='upload'?'#6c4cf7':'#222',background:activeTab==='upload'?'#ece8fa':'none',borderRadius:'8px',marginBottom:'0.5rem'}}>Upload</li>
                    <li className={activeTab === 'badges' ? 'active' : ''} onClick={() => setActiveTab('badges')} style={{cursor:'pointer',padding:'1rem',fontWeight:'bold',color:activeTab==='badges'?'#6c4cf7':'#222',background:activeTab==='badges'?'#ece8fa':'none',borderRadius:'8px',marginBottom:'0.5rem'}}>Badges</li>
                    <li className={activeTab === 'notifications' ? 'active' : ''} onClick={() => setActiveTab('notifications')} style={{cursor:'pointer',padding:'1rem',fontWeight:'bold',color:activeTab==='notifications'?'#6c4cf7':'#222',background:activeTab==='notifications'?'#ece8fa':'none',borderRadius:'8px',marginBottom:'0.5rem'}}>Notifications</li>
                  </ul>
                </nav>
              </aside>
              {/* Rightbar */}
