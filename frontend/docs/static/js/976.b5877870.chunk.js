...
(globalThis.webpackChunkautopromote_frontend =
  ...
  [976],
  {
    2976(e, t, l) {
      ...
      const i = e => {
          let { md: t } = e;
          return t ? (0, d.jsx)(s.oz, { children: t }) : null;
        },
        r = () => {
          const e = (0, n.zy)().pathname.replace(/^\/blog\/?/, "");
          if (e) {
            const t = o.find(t => t.slug === e);
            return t
              ? (0, d.jsxs)("div", {
                  style: { padding: 24, maxWidth: 900, margin: "0 auto" },
                  children: [
                    (0, d.jsx)(a.N_, { to: "/blog", children: "\u2190 Back to Blog" }),
                    (0, d.jsx)("h1", { children: t.title }),
                    (0, d.jsx)("small", { children: t.date }),
                    (0, d.jsx)(i, { md: t.content }),
                  ],
                })
              : (0, d.jsx)("div", { style: { padding: 24 }, children: "Post not found." });
          }
          return (0, d.jsxs)("div", {
            style: { padding: 24, maxWidth: 900, margin: "0 auto" },
            children: [
              (0, d.jsx)("h1", { children: "Blog" }),
              (0, d.jsx)("p", { children: "Read the latest updates from the AutoPromote team." }),
              (0, d.jsx)("ul", {
                children: o.map(e =>
                  (0, d.jsx)(
                    "li",
                    {
                      children: (0, d.jsxs)(a.N_, {
                        to: `/blog/${e.slug}`,
...
//# sourceMappingURL=976.b5877870.chunk.js.map
