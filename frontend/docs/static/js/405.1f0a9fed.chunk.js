...
(globalThis.webpackChunkautopromote_frontend =
  ...
  [405],
  {
    6405(e, n, t) {
      ...
      const d = e => {
          let { md: n } = e;
          return n ? (0, l.jsx)(s.oz, { children: n }) : null;
        },
        c = () => {
          const e = (0, o.zy)().pathname.replace(/^\/docs\/?/, "");
          if (e) {
            const n = a.find(n => n.slug === e);
            return n
              ? (0, l.jsxs)("div", {
                  style: { padding: 24, maxWidth: 900, margin: "0 auto" },
                  children: [
                    (0, l.jsx)(r.N_, { to: "/docs", children: "\u2190 Back to Docs" }),
                    (0, l.jsx)("h1", { children: n.title }),
                    (0, l.jsx)(d, { md: n.content }),
                  ],
                })
              : (0, l.jsx)("div", { style: { padding: 24 }, children: "Document not found." });
          }
          return (0, l.jsxs)("div", {
            style: { padding: 24, maxWidth: 900, margin: "0 auto" },
            children: [
              (0, l.jsx)("h1", { children: "Documentation" }),
              (0, l.jsx)("p", {
              ...
              (0, l.jsx)("ul", {
                children: a.map(e =>
                  (0, l.jsx)(
                    "li",
                    { children: (0, l.jsx)(r.N_, { to: `/docs/${e.slug}`, children: e.title }) },
                    e.slug
                  )
                ),
              }),
...
//# sourceMappingURL=405.1f0a9fed.chunk.js.map
