...
# A failed video render can consume the same 8-vCPU budget twice. Surface the
# failure to the durable job record and require an explicit user retry.
